...
struct ssd_info *
flash_page_state_modify(struct ssd_info *, struct sub_request *, unsigned int, unsigned int, unsigned int, unsigned int,
                        unsigned int, unsigned int);

struct ssd_info *
make_same_level(struct ssd_info *, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);

int find_level_page(struct ssd_info *, unsigned int, unsigned int, unsigned int, struct sub_request *,
                    struct sub_request *);
...
int find_twoplane_write_sub_request(struct ssd_info *ssd, unsigned int channel, struct sub_request *sub_twoplane_one,
                                    struct sub_request *sub_twoplane_two);

int find_interleave_sub_request(struct ssd_info *ssd, unsigned int channel, struct sub_request *sub_interleave_one,
                                struct sub_request *sub_interleave_two);
...
struct sub_request *
find_interleave_twoplane_page(struct ssd_info *ssd, struct sub_request *onepage, unsigned int command);
...
struct ssd_info *
un_greed_interleave_copyback(struct ssd_info *, unsigned int, unsigned int, unsigned int, struct sub_request *,
                             struct sub_request *);
...
int write_page(struct ssd_info *ssd, unsigned int channel, unsigned int chip, unsigned int die, unsigned int plane,
...
int  new_services_2_write(struct ssd_info *ssd, unsigned int channel, unsigned int *channel_busy_flag,unsigned int *change_current_time_flag); 


//judge whether write sub_request exist in pointed chip
int judge_write_existing_in_chip(struct ssd_info *ssd, int channel, int chip);
int judge_2read_existing_in_chip(struct ssd_info *ssd, int channel, int chip);
