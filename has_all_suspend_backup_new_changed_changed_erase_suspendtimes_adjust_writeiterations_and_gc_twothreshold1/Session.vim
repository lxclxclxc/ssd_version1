...
set tabstop=4
set tags=~/ssdsim/SSDsim_origin/tags
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/ssdsim/SSDsim_origin
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +336 ssd.c
badd +318 initialize.h
badd +145 initialize.c
badd +212 pagemap.c
badd +556 avlTree.c
badd +31 avlTree.h
badd +1 example.ascii
badd +1 page.parameters
badd +563 flash.c
badd +285 /usr/include/wchar.h
badd +554 /usr/include/string.h
badd +56 ssd.h
badd +754 /usr/include/stdio.h
badd +24 pagemap.h
badd +1 ex.out
argglobal
silent! argdel *
...
exe 'vert 1resize ' . ((&columns * 40 + 112) / 225)
exe '2resize ' . ((&lines * 32 + 33) / 67)
exe 'vert 2resize ' . ((&columns * 40 + 112) / 225)
exe '3resize ' . ((&lines * 2 + 33) / 67)
exe 'vert 3resize ' . ((&columns * 184 + 112) / 225)
exe '4resize ' . ((&lines * 62 + 33) / 67)
exe 'vert 4resize ' . ((&columns * 92 + 112) / 225)
exe '5resize ' . ((&lines * 62 + 33) / 67)
exe 'vert 5resize ' . ((&columns * 91 + 112) / 225)
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 341 - ((29 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
341
